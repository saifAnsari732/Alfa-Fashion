...
const OrderPage = () => {
  ...
  const handleWhatsAppOrder = (e) => {
    ...
    window.open(`https://wa.me/9120594727?text=${text}`, '_blank');
  };
          ...
          <div className="bg-white rounded-[2rem] shadow-xl p-8 sm:p-10 border border-slate-100">
            <form onSubmit={handleWhatsAppOrder} className="space-y-6">
              ...
              <div className="pt-4 flex flex-col sm:flex-row gap-4">
                ...
                <a href="tel:+919120594727" className="flex-1 bg-white border-2 border-slate-200 hover:border-[#2B231D] text-[#2B231D] py-4 rounded-xl font-bold flex items-center justify-center gap-2 transition-colors">

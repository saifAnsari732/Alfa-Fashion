          ...
          <div className="flex items-center justify-between h-16">
            <Link to="/">
              ...
              >
                ...
                <div className="flex flex-col leading-tight">
                  <h1 className="text-lg sm:text-2xl font-black font-display text-slate-900 dark:text-white">Factory Price</h1>
                  <p className="text-[10px] sm:text-xs uppercase tracking-[0.35em] text-blue-600 dark:text-sky-400 font-bold">Wholesale & retail</p>
                </div>
              </motion.div>
            </Link>
              ...
              {navItems.map((item) => (
                item.path === '/deals' ? (
                  <Link
                    key={item.name}
                    to={item.path}
                    className={`text-sm font-semibold tracking-widest transition-colors ${location.pathname === item.path ? 'text-blue-600' : 'text-slate-700 dark:text-slate-300 hover:text-blue-600 dark:hover:text-sky-400'}`}
                  >
                    {item.name}
                  </Link>
                ) : (
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                ...
                className="hidden sm:inline-flex px-4 sm:px-5 py-2 sm:py-2.5 rounded-full bg-slate-100 dark:bg-slate-900/80 text-slate-900 dark:text-white text-xs sm:text-sm font-black tracking-wide hover:bg-slate-200 dark:hover:bg-slate-800 transition-all shadow-sm"
              >
                Reviews
              </a>
            ...
            <div className="p-6">
              <div className="flex justify-between items-center mb-12">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="text-xl font-bold text-white">Factory Price</h1>
                    <p className="text-[10px] uppercase tracking-[0.35em] text-blue-300 font-bold">Wholesale & retail</p>
                  </div>
                </div>
